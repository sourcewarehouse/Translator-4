...
namespace java {
  namespace lang {
    ...
    int32_t __Object::m_hashCode(Object __this) {
      return (int32_t)(intptr_t)__this.raw();
    }

    // java.lang.Object.equals(Object)
    bool __Object::m_equals(Object __this, Object other) {
      return __this.raw() == other.raw();
    }

    // java.lang.Object.getClass()
    Class __Object::m_getClass(Object __this) {
      return __this->__vptr->__isa;
    }

    // java.lang.Object.toString()
    String __Object::m_toString(Object __this) {
      // Class k = this.getClass();
      Class k = __this->__vptr->m_getClass(__this);
    ...
    int32_t __String::m_hashCode(String __this) {
      int32_t hash = 0;
    ...
    bool __String::m_equals(String __this, Object o) {
    ...
    String __String::m_toString(String __this) {
      return __this;
    }
    ...
    String __Class::m_toString(Class __this) {
      if (__this->primitive) {
        return __this->name;
      } else {
    ...
    bool __Class::isInstance(Class __this, Object o) {
      Class k = o->__vptr->m_getClass(o);

      do {
        if (__this->__vptr->m_equals(__this, k)) return true;
...
namespace __rt {
  ...
  // TWO DIMENTIONAL ARRAYS
    ...
    // Template specialization for arrays of ints.
  template<>
  java::lang::Class Array2D<int32_t>::__class() {
    static java::lang::Class k =
      new java::lang::__Class(literal("[[I"),
                              java::lang::__Object::__class(),
                              java::lang::__Integer::TYPE());
  ...
  // Template specialization for arrays of objects.
  template<>
  java::lang::Class Array2D<java::lang::Object>::__class() {
    static java::lang::Class k =
      new java::lang::__Class(literal("[[Ljava.lang.Object;"),
                              java::lang::__Object::__class(),
                              java::lang::__Object::__class());
  ...
  // Template specialization for arrays of strings.
  template<>
  java::lang::Class Array2D<java::lang::String>::__class() {
    static java::lang::Class k =
      new java::lang::__Class(literal("[[Ljava.lang.String;"),
                              Array2D<java::lang::Object>::__class(),
                              java::lang::__String::__class());
    return k;
  }
